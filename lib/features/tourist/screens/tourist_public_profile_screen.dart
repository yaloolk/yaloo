...
class TouristPublicProfileScreen extends StatelessWidget {
  const TouristPublicProfileScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // --- Receive Tourist data from arguments ---
    final touristData = ModalRoute.of(context)?.settings.arguments as Map<String, dynamic>? ?? {};
    final String touristName = touristData['name'] ?? "Mohamed";
    final String touristImage = touristData['image'] ?? "assets/images/guide_1.png";
    final String touristLocation = touristData['location'] ?? "Kandy, Sri Lanka";
    final String touristRating = touristData['rating'] ?? "4.6";
    // --------------------------------------------------
              ...
              SliverList(
                delegate: SliverChildListDelegate(
                  [
                    ...
                    _buildProfileCard(context, touristName, touristImage),
                    _buildAboutSection(),
                    _buildDetailsCard(),
    ...
    return Container(
      ...
      child: Column(
        children: [
          CircleAvatar(
            radius: 50.r,
            backgroundImage: AssetImage("assets/images/tourist_1.jpg"),
          ),
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 12.h),
          Text(
            'Hello! Adventure enthusiast who hiking, exploring historical local cuisine, fo unique cultural experiences.',
            style: AppTextStyles.textSmall.copyWith(
              color: AppColors.primaryGray,
              fontSize: 15.sp,
              height: 1.5,
  ...
  Widget _buildDetailsCard() {
    return Container(
      ...
      child: Column(
        children: [
          _buildDetailRow("Languages", "English, German"),
          SizedBox(height: 16.h),
          Divider(color: Colors.grey.shade300, height: 1.h),
          SizedBox(height: 16.h),
          _buildDetailRow("Yaloo Since", "June 2025"),
          SizedBox(height: 16.h),
          Divider(color: Colors.grey.shade300, height: 1.h),
          SizedBox(height: 16.h),
          _buildDetailRow("Tours Completed", "2"),
        ],
      ),
    );
  }
      ...
      child: Padding(
        ...
        child: Column(
          children: [
            ...
            SizedBox(height: 12.h),
            Text(
              'An absolutely incredible experience! Emil is so knowledgeable and friendly.',
              style: AppTextStyles.textSmall.copyWith(
                color: AppColors.primaryGray,
                height: 1.4,
              ),
